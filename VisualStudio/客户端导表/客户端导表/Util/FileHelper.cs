...
public static class FileHelper
{
    ...
    public static bool CreateDirectory(string path)
    {
        ...
        {
            Console.WriteLine("FileHelper.CreateDirectory Error:" + exception.ToString());
            return false;
        }
    ...
    public static bool DeleteDirectory(string path)
    {
        ...
        {
            Console.WriteLine("FileHelper.DeleteDirectory Error:" + exception.ToString());
            return false;
        }
    ...
    public static byte[] ReadFile(string path)
    {
        if (FileExists(path))
        {
            ...
            {
                Console.WriteLine("FileHelper.ReadFile Error:" + exception.ToString());
            }
            return bytes;
        }
        return null;
    ...
    public static string ReadText(string path)
    {
        if (FileExists(path))
        {
            ...
            {
                Console.WriteLine("FileHelper.ReadText Error:" + exception.ToString());
            }
            return text;
        }
        return null;
    ...
    public static string[] ReadLines(string path)
    {
        if (FileExists(path))
        {
            ...
            {
                Console.WriteLine("FileHelper.ReadLines Error:" + exception.ToString());
            }
            return lines;
        }
    ...
    public static bool WriteFile(string path, string folder, string name, byte[] bytes, bool overwrite)
    {
        ...
        {
            Console.WriteLine("FileHelper.WriteFile Error:" + exception.ToString());
            return false;
        }
    ...
    public static bool DeleteFile(string path)
    {
        ...
        {
            Console.WriteLine("FileHelper.DeleteFile Error:" + exception.ToString());
            return false;
        }
    ...
    public static bool MoveFile(string sourcePath, string destPath, string destFolder)
    {
        ...
        {
            Console.WriteLine("FileHelper.MoveFile Error:" + exception.ToString());
            return false;
        }
    ...
    {
        destPath = FormatWinPath(destPath);
    ...
    public static bool CopyFile(string sourcePath, string destPath, string destFolder, bool overwirte)
    {
        ...
        {
            Console.WriteLine("FileHelper.CopyFile Error:" + exception.ToString());
            return false;
        }
    ...
    public static string GetFileName(string filePath)
    {
        ...
        return filePath.Substring(lastIndex1 + 1, filePath.LastIndexOf(".") - lastIndex1 - 1);
    }
